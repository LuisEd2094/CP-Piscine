...
class BitcoinExchange
{
    private:
        ...
        void workOnFile(std::string filePath, std::string sep, std::string firstLine, void (BitcoinExchange::*f)(std::string, float), bool (BitcoinExchange::*validPrice)(float), void (BitcoinExchange::*handleError)(std::string));
